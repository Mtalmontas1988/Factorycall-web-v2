...
export const modules: PortalModule[] = [
  ...
  { slug: 'nuotrauku-standartai', label: 'Nuotraukų standartai', singular: 'nuotraukų standartą', icon: PhotoLibraryOutlined, description: 'Produktų, pakuočių ir gamybos vizualūs standartai.', columns: [], rows: [] },
