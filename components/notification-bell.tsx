...
import { Alert, Badge, Box, Button, IconButton, Paper, Popover, Stack, Typography } from '@mui/material';
import { useNotificationsContext } from '../hooks/notifications-context';
import { useI18n } from '../i18n/i18n-provider';
import { InlineListSkeleton } from './page-skeleton';
...
export function NotificationBell() {
  ...
  return <>
    ...
    <Popover open={Boolean(anchor)} anchorEl={anchor} onClose={() => setAnchor(null)} anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }}>
      <Paper sx={{ width: { xs: 'calc(100vw - 32px)', sm: 360 }, maxWidth: 360, p: 2 }}>
