...
export function PortalShell({ slug, data }: {
    ...
    const { calls, technicians, operators, lines, problems, users, tokens, preventiveWorks, liveModules, loading, error } = data;
