...
const timestamp = (value?: number | string, fallback?: string) => { const stamp = Number(value ?? 0); return Number.isFinite(stamp) && stamp > 0 ? new Date(stamp).toLocaleString('lt-LT') : fallback || '—'; };
const nameOf = (technician: Technician) => technician.name || technician.email || technician.id || 'Neįvardytas technikas';
